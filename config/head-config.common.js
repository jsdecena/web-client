...
module.exports = {
  link: [
    ...
    { rel: 'stylesheet', href: 'https://cdnjs.cloudflare.com/ajax/libs/admin-lte/2.3.11/css/AdminLTE.min.css' },
    { rel: 'stylesheet', href: 'https://cdnjs.cloudflare.com/ajax/libs/admin-lte/2.3.11/css/skins/skin-blue.min.css' },
    { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css?family=Nunito:200,300,400,600,700'},
    /**
  ...
  script: [
    { rel: 'text/javascript', src: 'https://cdnjs.cloudflare.com/ajax/libs/jquery/2.2.3/jquery.min.js' },
    { rel: 'text/javascript', src: 'https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/js/bootstrap.min.js' },
    { rel: 'text/javascript', src: 'https://cdnjs.cloudflare.com/ajax/libs/admin-lte/2.3.11/js/app.min.js' },
  ]
};
